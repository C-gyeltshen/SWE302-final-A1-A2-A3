...
test.describe('ArticleList component', () => {
  ...
  test('should show empty state when articles array is empty', async ({ page }) => {
  ...
  test('should render articles when available', async ({ page }) => {
    ...
    await page.waitForSelector('.article-preview, text=No articles are here... yet.', { timeout: 10000 });
  ...
  test('should render ListPagination when articles count is high', async ({ page }) => {
    await page.goto('http://localhost:4100');
    await page.waitForLoadState('networkidle');
  ...
  test('should display article information correctly', async ({ page }) => {
    ...
    if (count > 0) {
      ...
      const favoriteBtn = firstArticle.locator('button.btn-primary, button.btn-outline-primary');
  ...
  test('should navigate to article detail when clicking article', async ({ page }) => {
    await page.goto('http://localhost:4100');
    await page.waitForLoadState('networkidle');
